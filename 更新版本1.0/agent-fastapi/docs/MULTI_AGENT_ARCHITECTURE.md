...
| P2-07 | 前端 PreferenceCard 组件 | [x] | `pages/chat/component/PreferenceCard.vue` | 前端渲染偏好卡测试 |
| P2-08 | 前端 Store 适配 | [x] | `store/index.ts` | 接收 preference_card 消息类型 |
...
| P4-03 | 集成测试 | [x] | `tests/` | `pytest tests/integration/ -v` → 44 passed |
| P4-04 | 端到端测试 | [x] | `tests/` | `pytest tests/e2e/ -v` → 11 passed |
